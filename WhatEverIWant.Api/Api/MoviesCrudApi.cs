...
public static class MoviesCrudApi
{
    ...
    public static void MapMoviesApi(this WebApplication app)
    {
        ...
        group.MapGet("/{id:long}", async Task (long id, IMovieService movieService) => await movieService.GetByIdAsync(id).OkOrNotFoundAsync())
        ...
        group.MapPut("/{id:long}", async Task (long id, UpdateMovieRequest request, IMovieService movieService) => await movieService.UpdateAsync(id, request).NoContentOrNoFoundAsync())
        ...
        group.MapDelete("/{id:long}", async Task (long id, IMovieService movieService) => await movieService.DeleteAsync(id).NoContentOrNoFoundAsync())
